                            ...
                            <div className="lg:col-span-8">
                                ...
                                <div className="mt-6 flex items-center gap-4">
                                    ...
                                    <div className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                                        <p className="text-[10px] text-emerald-500/60 font-black uppercase tracking-widest leading-none mb-1">
                                            Forecast
                                        </p>
                                ...
                                <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-4">
                                    ...
                                    <div className="space-y-2">
                                        {heroStats.map((item) => (
                                            <div
                                                key={item.label}
                                                className={`rounded-lg px-3 py-3 border transition-colors ${item.highlight
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={`mt-1 text-lg font-black ${item.highlight ? "text-emerald-400" : "text-white"
                                                        }`}
                                                >
                                                    {item.value}
                                                </div>
                                ...
                                >
                                    ...
                                    <Tooltip
                                        formatter={(value) => {
                                            ...
                                            return [`+₹${safeValue}L`, "Revenue Impact"];
                                        }}
                                        contentStyle={{
                                            borderRadius: 16,
                                            border: "none",
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
                    {kpis.map((kpi, idx) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`absolute -right-4 -top-4 w-24 h-24 blur-[40px] opacity-[0.08] transition-opacity group-hover:opacity-15 rounded-full bg-${theme.accent}-500`}
                                />
                                ...
                                <div className="flex items-center justify-between gap-4 relative z-10">
                                    ...
                                    <div
                                        className={`h-11 w-11 rounded-xl flex items-center justify-center text-white shadow-lg shrink-0 transition-transform group-hover:scale-110 ${theme.iconBg}`}
                                    >
                                    ...
                                    <tr key={row.hotel} className="hover:bg-slate-50 transition-all group cursor-default">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="font-bold text-slate-900">{row.hotel}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-5 font-bold text-slate-400">{row.before}</td>
                                        <td className="px-8 py-5 font-black text-slate-900">{row.after}</td>
                                        <td className="px-8 py-5">
